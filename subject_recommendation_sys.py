...
#opinion = st.text_input('Enter your desired subject (Science, Commerce, Arts):')
...
# Button for comparison with Science
if st.button('Compare with Science'):
    try:
        ...
        sns.lineplot(x=columns, y=science_means, label='Mean Science Scores', marker='o', color='blue', ax=ax)
        ax.plot(columns, input_list, label='Your Score', marker='o', color='black', linestyle='--')
        ax.set_xticklabels(columns, rotation=90, ha='right')
        ax.legend(title="Subjects")
        ax.set_title("Comparison with Science")
        ax.grid(True)
        st.pyplot(fig)
...
# Button for comparison with Arts
if st.button('Compare with Arts'):
    try:
        ...
        # Using Seaborn for a more aesthetic plot
        sns.lineplot(x=columns, y=arts_means, label='Mean Arts Scores', marker='o', color='red', ax=ax)
        ax.plot(columns, input_list, label='Your Score', marker='o', color='black', linestyle='--')
        ax.set_xticklabels(columns, rotation=90, ha='right')
        ax.legend(title="Subjects")
        ax.set_title("Comparison with Arts")
        ax.grid(True)
        st.pyplot(fig)
...
# Button for comparison with Commerce
if st.button('Compare with Commerce'):
    try:
        ...
        # Using Seaborn for a more aesthetic plot
        sns.lineplot(x=columns, y=com_means, label='Mean Commerce Scores', marker='o', color='green', ax=ax)
        ax.plot(columns, input_list, label='Your Score', marker='o', color='black', linestyle='--')
        ax.set_xticklabels(columns, rotation=90, ha='right')
        ax.legend(title="Subjects")
        ax.set_title("Comparison with Commerce")
        ax.grid(True)
        st.pyplot(fig)
