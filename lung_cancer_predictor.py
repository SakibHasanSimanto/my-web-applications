...
if st.button('নির্দেশাবলী'):
    ...
    arr2 = ['আপনার লিঙ্গ?', 'বয়স?', 'ধূমপান করেন?', 'ত্বক/আংগুল মাঝেমধ্যে হলুদ হয়ে যায়?',
            ...
            'দীর্ঘমেয়াদী কোনো অসুখ আছে?', ' অতিরিক্ত ক্লান্তি অনুভব করেন?', 'এলার্জি আছে?',
...
with col2:
    ...
    fatig = st.text_input(' অতিরিক্ত ক্লান্তি অনুভব করেন?')
...
if st.button('মন্তব্য'):
    try:
        if st.session_state.outcome == 1:
            ...
            st.warning("অনুগ্রহ করে প্রথমে 'পূর্বাভাস' ক্লিক করুন।")
...
if st.button('সম্ভাব্য ঝুঁকি'):
    try:
        st.write('যে সকল প্রভাবক ফুসফুস ক্যান্সারে নেতিবাচক প্রভাব ফেলতে পারে-')
