...
if st.button('Disclaimer'):
    try:
        st.write('This model is still on the phase of simulation learning, which indicates that the trained data in synthetically generated which resembles real-life crime data. Nevertheless, the strength of real-life data almost always outperforms simulated models.')
